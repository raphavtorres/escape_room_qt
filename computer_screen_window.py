...
class Ui_ComputerScreen(object):
    def setupUi(self, ComputerScreen):
        ...
        self.passwordbox_lb.setPixmap(QtGui.QPixmap(":/background/images/gamer_room_fase/password.png"))
...
"")
        ...
        self.file_opened_frame = QtWidgets.QFrame(self.centralwidget)
        self.file_opened_frame.setGeometry(QtCore.QRect(10, 90, 561, 461))
        self.file_opened_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.file_opened_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.file_opened_frame.setObjectName("file_opened_frame")
        self.file_opened_lb = QtWidgets.QLabel(self.file_opened_frame)
        self.file_opened_lb.setGeometry(QtCore.QRect(80, 0, 411, 391))
        self.file_opened_lb.setText("")
        self.file_opened_lb.setPixmap(QtGui.QPixmap(":/background/images/gamer_room_fase/file_opened.png"))
        self.file_opened_lb.setScaledContents(True)
        self.file_opened_lb.setObjectName("file_opened_lb")
        self.get_truck_btn = QtWidgets.QPushButton(self.file_opened_frame)
        self.get_truck_btn.setGeometry(QtCore.QRect(230, 90, 161, 121))
        self.get_truck_btn.setStyleSheet("background-color: rgba(0,0,0,0);")
        self.get_truck_btn.setText("")
        self.get_truck_btn.setObjectName("get_truck_btn")
